# AK-FILE-TO-LINK-BOT - A Telegram bot that can stream Telegram files to users over HTTP.
# Copyright (C) 2021 AK-BOTZ
#
...
session_name = os.environ.get("TG_SESSION_NAME", "AK-FILE-TO-LINK-BOT")
